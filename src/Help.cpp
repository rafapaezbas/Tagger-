...
void help::printHelp(){
  ...
  std::cout << "tagger [-c [-i input] -o output | [-t | -a] -p pattern] -d directory " << std::endl;
  std::cout << "" << std::endl;
  ...
  std::cout << "\t -t: change title for files under root directory following pattern specified by option -p." << std::endl;
  std::cout << "" << std::endl;
}
